...
import modernImgAsset from "@/assets/En-modern-konyveloirodaban.jpg.asset.json";
const modernImg = modernImgAsset.url;
...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "XLNT NAV Pénztárgép letöltő",
  ...
  },
  {
    ...
    features: [
      ...
      "Mindig naprakész — az adott évi bevalláshoz igazítva, f1–f4 és h1–h4 oszlopokkal.",
    ...
    tiers: [
      {
        ...
        label: "1 cég",
        price: 34900,
        note: "Egyetlen adószám bevallásaihoz. A megvásárolt licenc a megrendelés évére érvényes – a szabályok évi változása miatt évente új verziót kell vásárolni.",
        priceId: "afa_ev65_xml_generalo_1_ceg",
      },
      {
        id: "korlatlan",
        label: "Korlátlan",
        price: 99900,
        note: "Könyvelőirodáknak, korlátlan ügyfélszámmal. A megvásárolt licenc a megrendelés évére érvényes – a szabályok évi változása miatt évente új verziót kell vásárolni.",
        priceId: "afa_ev65_xml_generalo_korlatlan",
      },
    ],
    download: {
  ...
  },
  {
    ...
    name: "XLNT Ügyfélkapu+ TOTP Manager",
    ...
    tiers: [
      {
        ...
        label: "1 cég",
        price: 24900,
        note: "Egyetlen adószám nyilatkozataihoz. A megvásárolt licenc a megrendelés évére érvényes – a szabályok évi változása miatt évente új verziót kell vásárolni.",
        priceId: "a60_osszesito_nyilatkozat_xml_1_ceg",
      },
      {
        ...
        price: 59900,
        note: "Korlátozás nélkül, bármennyi ügyfélre. A megvásárolt licenc a megrendelés évére érvényes – a szabályok évi változása miatt évente új verziót kell vásárolni.",
  ...
  },
  {
    ...
    name: "XLNT NAV Törzsszám- és Partnerellenőrző",
  ...
  },
  {
    ...
    features: [
      ...
      "Minden fontos kedvezmény – 25 év alatti fiatalok kedvezménye, első házasok kedvezménye, családi kedvezmény és a családi járulékkedvezmény, az aktuális évi értékhatárokkal.",
    ...
    tiers: [
      {
        ...
        label: "Alap",
        price: 24900,
        note: "Egy cég bérszámfejtéséhez. A megvásárolt licenc a megrendelés évére érvényes – a szabályok évi változása miatt évente új verziót kell vásárolni.",
        priceId: "berszamfejto_alap",
      },
      {
        id: "konyveloi",
        ...
        price: 74900,
        note: "Könyvelőirodáknak, korlátlan ügyfélszámmal. A megvásárolt licenc a megrendelés évére érvényes – a szabályok évi változása miatt évente új verziót kell vásárolni.",
        priceId: "berszamfejto_tobbceges",
      },
    ],
    download: {
      fileName: "Berszamfejto.xlsm",
      storagePath: "berszamfejto-2026/Berszamfejto_2026.xlsm",
    },
  },
  {
    slug: "utalasi-csomag-keszito",
    name: "XLNT Banki Utalási Csomag Készítő Excelben",
  ...
  },
  {
    ...
    intro: [
      ...
      "A megvásárolt licenc a megrendelés évére érvényes beszámoló-verzióra vonatkozik. Mivel a hatályos szabályok és a beküldési űrlapok évente változhatnak, a programból minden évben frissített változat készül — az új évi beszámoló elkészítéséhez az aktuális évhez tartozó verziót külön meg kell vásárolni.",
    ],
    features: [
    ...
    tiers: [
      {
        ...
        label: "Céges licenc",
        price: 24900,
        note: "Egyetlen adószámhoz kötve. A megvásárolt licenc a megrendelés évére érvényes – a szabályok évi változása miatt évente új verziót kell vásárolni.",
        priceId: "beszamolo_egy_ceg",
      },
      {
        id: "konyveloiroda",
        label: "Könyvelőiroda",
        price: 44900,
        note: "Adószám-korlátozás nélkül, korlátlan számú cégre. A megvásárolt licenc a megrendelés évére érvényes – a szabályok évi változása miatt évente új verziót kell vásárolni.",
        priceId: "beszamolo_konyveloiroda",
      },
    ],
    download: {
      fileName: "XLNT_Beszamolo.xlsm",
  ...
  },
  {
    ...
    name: "XLNT Kulcs-Soft Bejövő Külföldi Számla Import",
  ...
  },
  {
    ...
    name: "XLNT RLB Bejövő Külföldi Számla Import",
  ...
  },
  {
    ...
    name: "XLNT Nyitó és Vegyes Könyvelő – RLB kiadás",
  ...
  },
  {
    ...
    name: "XLNT Nyitó és Vegyes Könyvelő – Kulcs-Soft kiadás",
    tagline:
  ...
  },
  {
    ...
    name: "XLNT Nyitó és Vegyes Könyvelő – SUP kiadás",
    tagline:
  ...
  },
  {
    ...
    name: "XLNT Univerzális bankkivonat-konverter",
  ...
  },
  {
    ...
    why: "Elsősorban olyan könyvelőirodáknak és pénzügyi szakembereknek, akik devizaszámlával rendelkező ügyfeleket könyvelnek, és akiknek jelenlegi programja vagy Excel-sablonja nem, vagy csak tételek mesterséges szétbontásával kezeli a fenti hat esetet. Korlátok őszintén: a XLNT DEVIZABANK Excel/VBA-alapú munkafüzet, nem önálló adatbázisra épülő könyvelőprogram – a tételeket kézzel (bankkivonatból) kell rögzíteni, automatikus bankkivonat-importot nem tartalmaz. Használatához Microsoft Excel szükséges, makrókat engedélyező beállítással. A program lapvédelemmel és időkorláthoz kötött licenccel védett; a licencidőszak lejárta után a fejlesztőtől kérhető a frissítés.",
    tiers: [
      {
  ...
  },
  {
    ...
    name: "XLNT Ingatlanalap MNB Jelentés-előkészítő – NEÉ Számoló és ERA/STEFI Generátor",
    tagline:
