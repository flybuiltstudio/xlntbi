...
export const products: Product[] = [
  ...
  },
  {
    ...
    tagline: "Konszolidált beszámoló a magyar számviteli törvény szerint – egyetlen Excelben",
    status: "available",
    ...
    metaDescription: "Konszolidált beszámoló a magyar számviteli törvény szerint – egyetlen Excelben. Ár: 79 900 Ft-tól.",
    intro: [
    ...
    features: [
      "Mérleg „A” és „B” változat, összköltség és forgalmi költség eljárású eredménykimutatás, cash flow a 7. sz. melléklet szerint – az 1., 2., 3., 6. és 7. melléklet alapján.",
      "A korrekciók egy naplóban, tartozik/követel bontásban. A munkatábla soronként számol: egyedi összeg + kvóta × árfolyam + korrekció = konszolidált érték.",
      "Tőkekonszolidáció, adósság-, közbenső eredmény-, bevétel/ráfordítás-konszolidálás, equity (társult) és adókülönbözet – gombnyomásra naplózva.",
      "Cégenkénti záró- és átlagárfolyam, automatikus átszámítás; az árfolyam-különbözet a saját tőkében jelenik meg (Szt. 22.§).",
      "Eszközök = források, napló T = K, eredmény = mérleg szerinti eredmény, cash flow = pénzeszköz-változás – egy helyen, a kezdőlapon is.",
    ],
    tiers: [
      {
        id: "egy_cegcsoport",
