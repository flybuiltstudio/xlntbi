...
const TITLE_BASE = "XLNT Éves beszámoló készítő program | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Állítsd össze gyorsan, hibamentesen az éves beszámolót a hatályos szabályok szerint, Excel alapú sablonnal.";
const H1 = "XLNT Éves beszámoló készítő";
const CANONICAL = "https://xlntbi.hu/termek/beszamolo";
const SLUG = "beszamolo";
