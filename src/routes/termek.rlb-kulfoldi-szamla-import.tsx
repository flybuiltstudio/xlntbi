...
const TITLE_BASE = "XLNT Külföldi számla import RLB könyvelőprogramba | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Importáld gyorsan a külföldi bankszámlakivonatokat az RLB könyvelőprogramba, automatizált feldolgozással.";
const H1 = "XLNT Külföldi számla import, RLB";
const CANONICAL = "https://xlntbi.hu/termek/rlb-kulfoldi-szamla-import";
const SLUG = "rlb-kulfoldi-szamla-import";
