...
const TITLE_BASE = "XLNT Külföldi bankszámla import Pénzsz@mla rendszerbe | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Importáld gyorsan a külföldi bankszámlakivonatokat a Pénzsz@mla könyvelőprogramba, kézi rögzítés nélkül.";
...
const SLUG = "penzszam-kulfoldi-szamla-import";
