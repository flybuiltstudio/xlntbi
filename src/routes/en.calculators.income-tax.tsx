...
import { html, script } from "@/lib/calculators/jovedelemado-en";
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-14 md:py-16">
        <p className="max-w-3xl text-base text-muted-foreground">Personal income tax calculator. The calculation is for information purposes only.</p>
        <div className="mt-8">
          <EmbeddedCalculator
