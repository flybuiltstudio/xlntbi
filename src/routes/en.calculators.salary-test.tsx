  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 py-14 md:py-16">
        <p className="max-w-3xl text-base text-muted-foreground">Monthly payroll calculator for 30 types of employment relationship, with the main tax base allowances. The interface of the calculator is in Hungarian; the calculation is for information purposes only.</p>
        <div className="mt-8">
          <EmbeddedCalculator
