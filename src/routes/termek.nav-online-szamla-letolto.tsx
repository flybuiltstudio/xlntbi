...
const TITLE_BASE = "XLNT NAV Online Számla letöltő program | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Töltsd le automatikusan a NAV Online Számla rendszeréből a bejövő és kimenő számlák adatait, könyvelésre kész formátumban.";
const H1 = "XLNT NAV Online Számla letöltő";
const CANONICAL = "https://xlntbi.hu/termek/nav-online-szamla-letolto";
const SLUG = "nav-online-szamla-letolto";
