...
const TITLE_BASE = "XLNT RLB nyitó és vegyes könyvelő program | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Generálj nyitó és vegyes könyvelési tételeket az RLB rendszerhez gyorsan, Excel alapú sablonból kiindulva.";
const H1 = "XLNT RLB nyitó, vegyes könyvelő";
const CANONICAL = "https://xlntbi.hu/termek/rlb-nyito-vegyes-konyvelo";
const SLUG = "rlb-nyito-vegyes-konyvelo";
