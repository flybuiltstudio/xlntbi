...
export const Route = createFileRoute("/fintech-es-bi")({
  head: () => ({
    ...
    links: [
      ...
      { rel: "alternate", hrefLang: "hu", href: "https://xlntbi.hu/fintech-es-bi" },
      { rel: "alternate", hrefLang: "en", href: "https://xlntbi.hu/en/fintech-and-bi" },
      { rel: "alternate", hrefLang: "x-default", href: "https://xlntbi.hu/fintech-es-bi" },
    ],
    scripts: [
      {
