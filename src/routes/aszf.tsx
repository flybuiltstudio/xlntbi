...
const DESC =
  "Az xlntbi.hu weboldalon elérhető szolgáltatásokra és digitális termékekre vonatkozó Általános Szerződési Feltételek: megrendelés, fizetés átutalással vagy bankkártyával, teljesítés, elállás.";
