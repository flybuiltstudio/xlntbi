...
const TITLE_BASE = "XLNT RLB bank konverter – alap kiadás banki kivonat importhoz | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Az alap kiadás: alakítsd át és importáld a banki kivonatokat egyszerűen az RLB könyvelőprogramba, kézi adatrögzítés nélkül. Bővített funkciókért válaszd a PRO verziót.";
const H1 = "XLNT RLB bank konverter";
const CANONICAL = "https://xlntbi.hu/termek/rlb-bank-konverter";
const SLUG = "rlb-bank-konverter";
