...
const TITLE_BASE = "XLNT Havi pénzügyi riport sablon | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Automatizált havi pénzügyi riport sablon, ami áttekinthetően mutatja cége havi teljesítményét és a fontos mutatókat.";
const H1 = "XLNT Havi riport";
const CANONICAL = "https://xlntbi.hu/termek/havi-riport";
const SLUG = "havi-riport";
