...
const TITLE_BASE = "XLNT NAV törzsszám, partnerellenőrző program | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Ellenőrizd tömegesen partnereid adószámát és NAV státuszát, hogy elkerüld a kockázatos üzleti partnerkapcsolatokat.";
const H1 = "XLNT NAV törzsszám, partnerellenőrző";
const CANONICAL = "https://xlntbi.hu/termek/nav-torzsszam-partnerellenorzo";
const SLUG = "nav-torzsszam-partnerellenorzo";
