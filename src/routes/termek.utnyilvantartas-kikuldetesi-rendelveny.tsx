...
const TITLE_BASE = "XLNT Útnyilvántartás és kiküldetési rendelvény sablon | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Vezess szabályos útnyilvántartást és készíts kiküldetési rendelvényt könnyen, a NAV elvárásainak megfelelően.";
...
const SLUG = "utnyilvantartas-kikuldetesi-rendelveny";
