...
const TITLE_BASE = "XLNT SUP nyitó és vegyes könyvelő program | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Generálj nyitó és vegyes könyvelési tételeket a SUP könyvelőrendszerhez gyorsan, Excel alapú sablonból kiindulva.";
const H1 = "XLNT SUP nyitó, vegyes könyvelő";
const CANONICAL = "https://xlntbi.hu/termek/sup-nyito-vegyes-konyvelo";
const SLUG = "sup-nyito-vegyes-konyvelo";
...
export const Route = createFileRoute("/termek/sup-nyito-vegyes-konyvelo")({
  head: () => ({
    meta: [
      { title: TITLE() },
    ...
    links: [
      { rel: "canonical", href: "https://xlntbi.hu/termek/sup-nyito-vegyes-konyvelo" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
                  ...
                  "url": "https://xlntbi.hu/termek/sup-nyito-vegyes-konyvelo",
...
function ProductRoute() {
  return <ProductDetail slug="sup-nyito-vegyes-konyvelo" h1={H1} />;
}
