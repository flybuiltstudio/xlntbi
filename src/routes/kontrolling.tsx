...
export const Route = createFileRoute("/kontrolling")({
  head: () => ({
    ...
    links: [
      ...
      { rel: "alternate", hrefLang: "hu", href: "https://xlntbi.hu/kontrolling" },
      { rel: "alternate", hrefLang: "en", href: "https://xlntbi.hu/en/controlling" },
      { rel: "alternate", hrefLang: "x-default", href: "https://xlntbi.hu/kontrolling" },
    ],
    scripts: [
      {
