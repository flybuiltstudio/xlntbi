...
const TITLE_BASE = "XLNT Bérszámfejtő program | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Excel alapú bérszámfejtő program az aktuális szabályok szerint, gyors és pontos bérszámfejtéshez kis és közepes cégeknek.";
const H1 = "XLNT Bérszámfejtő";
const CANONICAL = "https://xlntbi.hu/termek/berszamfejto";
const SLUG = "berszamfejto";
