...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    links: [
      ...
      { rel: "alternate", hrefLang: "hu", href: "https://xlntbi.hu/" },
      { rel: "alternate", hrefLang: "en", href: "https://xlntbi.hu/en" },
      { rel: "alternate", hrefLang: "x-default", href: "https://xlntbi.hu/" },
    ],
    scripts: [
      {
      ...
      <section className="relative isolate overflow-hidden bg-brand-dark">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-6 md:py-8">
          ...
          <h1 className="mt-4 text-[clamp(1.5rem,3.6vw,2.6rem)] font-bold leading-tight text-primary-foreground">
            <span>Könyvelés, adótanácsadás, kontrolling<br />Auditok &amp; Fintech és BI tanácsadás</span>
          </h1>
