...
const TITLE_BASE = "XLNT év65 ÁFA-bevallás ÁNYK XML-generáló | EXCELlent Business Intelligence";
const DESCRIPTION_BASE = "Generálj gyorsan, hibamentesen NAV kompatibilis XML fájlt az év65-ös ÁFA-bevalláshoz, Excelből kiindulva.";
const H1 = "XLNT év65 ÁFA-bevallás ÁNYK XML-generáló";
const CANONICAL = "https://xlntbi.hu/termek/afa-ev65-xml-generalo";
const SLUG = "afa-ev65-xml-generalo";
